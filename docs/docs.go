    ...
    "paths": {
        ...
        "/candidates/merge": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Merge request containing master_candidate_id and duplicate_candidate_ids",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.mergeCandidatesRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "500": {
                        "description": "Failed to merge candidates",
                        "schema": {
                            "type": "string"
                        }
                    }
    ...
    "definitions": {
        "api.FusedCandidateResponse": {
            ...
            "properties": {
                ...
                "computed_community_id": {
                    "type": "string"
                },
                "computed_community_summary": {
                    "type": "string"
                },
                "current_position": {
                    "type": "string"
                ...
                "interviews": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/api.InterviewSummaryResponse"
                    }
                },
                "llm_reasoning": {
                    "type": "string"
